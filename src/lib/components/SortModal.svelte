<script lang="ts">
  ...
  let options = {
    ...
    recent(a: CardProps, b: CardProps) {
      return 0;
    },
...
<div id="panel" class="fixed top-2 left-1/2 -translate-x-1/2 z-30 h-9 items-center justify-start btn btn-neutral btn-circle mx-auto p-2 sm:w-auto">
  <svg
    viewBox="0 0 32 32"
